...
#products .box{width: 200px; float: left;margin: 10px;padding: 10px;cursor: pointer;}
...
#new .box{width: 150px; float: left;margin: 10px;padding: 10px;cursor: pointer;}
#best{overflow: hidden; border: 3px solid #006AA7; margin-top: 10px}
#best .box{width: 150px; float: left;margin: 10px;padding: 10px;cursor: pointer;}
