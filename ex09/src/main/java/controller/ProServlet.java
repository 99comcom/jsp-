...
@WebServlet(value = {"/pro/update","/pro/slist.json","/pro/clist.json","/pro/read","/pro/list","/pro/list.json","/pro/insert"})
public class ProServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case"/pro/slist.json":
			...
			out.print(pdao.slist(pcode));
			break;
		
		case"/pro/clist.json":
			pcode=request.getParameter("pcode");
			out.print(pdao.clist(pcode));
		...
		case"/pro/list.json":
			...
			System.out.println(pdao.list(svo));
